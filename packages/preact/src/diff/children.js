...
export function diffChildren(
	...
	/** @type {VNode[]} */
	let oldChildren = (oldParentVNode && oldParentVNode.__k) || EMPTY_ARR;
...
function constructNewChildrenArray(
	...
	for (i = 0; i < newChildrenLength; i++) {
		...
		const matchingIndex = (childVNode.__i = findMatchingIndex(
			childVNode,
			oldChildren,
			skewedIndex,
		...
		const isMounting = oldVNode == NULL || oldVNode.__v == NULL;
...
function findMatchingIndex(
	...
	let shouldSearch =
		...
		remainingOldChildren >
		(oldVNode != NULL && (oldVNode.__u & MATCHED) == 0 ? 1 : 0);
